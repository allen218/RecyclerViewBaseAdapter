...
package com.example.recyclerviewbaseadapter.progress.loadmoreview;
 ...
 * 发现页列表使用
 */
public class LoadMoreSwipeRefreshLayout extends ViewGroup {
    private static final String LOG_TAG = LoadMoreSwipeRefreshLayout.class.getSimpleName();
